...
<div> <h3>Web Development Stack</h3> </div>
 ...
 [![Web Stack](https://skillicons.dev/icons?i=html,css,tailwind,bootstrap,sass,figma,javascript,ts,react,redux,nextjs,nodejs,expressjs,graphql,mongodb,mysql,prisma,firebase,git,github,docker,heroku,postman,netlify,vercel&perline=11)](https://skillicons.dev)
